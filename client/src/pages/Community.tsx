    ...
    <Layout>
      <div className="relative py-20 md:py-28 bg-blue-600 overflow-hidden min-h-[480px] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-6xl md:text-8xl font-heading font-black mb-8 text-white drop-shadow-xl tracking-tight leading-[0.9]">
            Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white">Community</span>
          </h1>
          <p className="text-xl md:text-3xl max-w-3xl mx-auto text-blue-50 font-bold leading-relaxed drop-shadow-md">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 mb-20 md:mb-32">
          <div className="space-y-10">
            <h2 className="text-4xl md:text-5xl font-heading font-black text-primary tracking-tight">What we believe</h2>
            <div className="space-y-8">
              {[
                ...
                <div key={i} className="flex gap-6 md:gap-8 group">
                  <div className={`w-16 h-16 md:w-20 md:h-20 rounded-3xl ${val.color} flex items-center justify-center shrink-0 text-white font-black text-2xl md:text-3xl shadow-xl group-hover:scale-110 transition-transform rotate-3 group-hover:rotate-0`}>
                    {i + 1}
                  </div>
                  <div className="pt-2">
                    <h3 className="font-heading font-bold text-2xl mb-2 text-foreground group-hover:text-primary transition-colors">{val.title}</h3>
                    <p className="text-muted-foreground font-medium text-lg leading-relaxed">{val.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-gradient-to-br from-white to-slate-50 p-8 md:p-12 rounded-[3rem] border border-slate-200 shadow-2xl relative overflow-hidden group">
             ...
             <h3 className="text-3xl md:text-4xl font-heading font-bold mb-10 flex items-center gap-4 text-foreground">
